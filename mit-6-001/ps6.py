...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        shifted_lower = list(string.ascii_lowercase)

        for index, letter in enumerate(letters_lower):
            new_index = 0
            if index + shift > 25:
                new_index = (index + shift) % 26
            else:
                new_index = index + shift
            shift_dict[letter] = shifted_lower[new_index]
            shift_dict[letter.upper()] = shifted_lower[new_index].upper()
    ...
    def apply_shift(self, shift):
        ...
        to_shift = self.get_message_text()
        shifted = ""
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            if valid_word_count > max_valid_words:
                ...
                best_shift = shift
                decrypted_text = shifted_message
